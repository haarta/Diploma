    ...
    <div className="online-consultations-page">
      <section className="online-consultations-hero">
        <div>
          ...
          <h1>Свяжитесь с врачом онлайн в удобное время</h1>
          <p>
            Получите рекомендации специалиста без визита в клинику. Выберите формат консультации,
            оставьте заявку и согласуйте удобное время разговора с врачом.
          </p>
        </div>
      </section>
