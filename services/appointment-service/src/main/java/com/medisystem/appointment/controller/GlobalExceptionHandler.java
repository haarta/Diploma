...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({DoctorNotFoundException.class, AppointmentNotFoundException.class, ReviewNotFoundException.class, PromotionNotFoundException.class, OnlineConsultationNotFoundException.class, NewsItemNotFoundException.class})
